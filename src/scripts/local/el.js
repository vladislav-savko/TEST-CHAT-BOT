...
export default {
    ...
    help: [
        "Για να αλλάξετε γλώσσα, γράψτε τη γλώσσα στην οποία θέλετε να αλληλεπιδράσει ο βοηθός μαζί σας. Για παράδειγμα, 'Μετάβαση στα Πολωνικά'",
        "Ο βοηθός μπορεί να μιλήσει σε 5 γλώσσες: \n - Αγγλικά \n - Ελληνικά \n - Ρωσικά \n - Ουκρανικά \n - Πολωνικά",
        "Για να ξεκινήσετε την αναζήτηση, πρέπει να καθορίσετε την τοποθεσία, τον τύπο ακινήτου (σπίτι, βίλα, διαμέρισμα, εμπορικό, οικόπεδο), τον τύπο αγγελίας (ενοικίαση ή αγορά) και τον προϋπολογισμό. Για παράδειγμα, *Θέλω να αγοράσω σπίτι στη Λεμεσό, ο προϋπολογισμός μου είναι πάνω από 100 χιλιάδες ευρώ*",
        "Ακολουθεί μια λίστα ανέσεων που μπορείτε να καταχωρίσετε: \n" +
        "- Τύπος ακινήτου *(Διαμέρισμα, Βίλα, Αυτόνομο σπίτι, Μονοκατοικία, Γραφείο, Ξενοδοχείο, Βιομηχανικό, Εμπορικός χώρος, Εστιατόριο, Αποθήκη, Στάθμευση, Κατάστημα, Εστιατόριο, Άλλη εμπορική ιδιοκτησία, Εμπορικό οικόπεδο, Κατοικία, Αγροτική γη)* _Θέλω διαμέρισμα_\n" +
        "- Τύπος αγγελίας *(Ενοικίαση, Βραχυχρόνια ενοικίαση, Πώληση)* _Ενδιαφέρομαι για αγορά_\n" +
        "- Τιμή\n" +
        "- Επίπλωση *(Χωρίς, Μερικώς, Πλήρως)* _Μερικώς επιπλωμένο_\n" +
        "- Κατάσταση ακινήτου *(Νέο, Δευτερογενής αγορά)* _Νέο ακίνητο_\n" +
        "- Κατάσταση *(Νέο, Καλή κατάσταση, Χρειάζεται ανακαίνιση)* _Καλή κατάσταση_\n" +
        "- Συναγερμός\n" +
        "- Κλιματισμός *(Παντού, Μόνο στα υπνοδωμάτια, Δεν υπάρχει)* _Χωρίς κλιματισμό_\n" +
        "- Θέρμανση *(Δεν υπάρχει, Κεντρική, Αερίου, Ηλεκτρική, Υγρό καύσιμο)* _Με θέρμανση αερίου_\n" +
        "- Θερμοσίφωνας *(Δεν υπάρχει, Κεντρικός, Boiler, Ηλιακό σύστημα, Φωτοβολταϊκό σύστημα)\n" +
        "- Μπαλκόνι\n" +
        "- Έτος κατασκευής\n" +
        "- Κατάσταση κτιρίου *(Έτοιμο προς κατοίκηση, Στη φάση κατασκευής)\n" +
        ...
        "- Ηλεκτρικό ρεύμα\n" +
        "- Ίντερνετ *(Δεν υπάρχει, Wi-Fi, Καλώδιο, Κινητό)\n" +
        "- Χαρακτηριστικά τοποθεσίας *(Δίπλα στη λίμνη, Δίπλα στη θάλασσα, Δίπλα σε πλαγιά, Δίπλα σε σχολείο, Υπέροχη θέα, Δίπλα σε αεροδρόμιο, Δίπλα σε ποταμό, Δίπλα σε δάσος, Δίπλα σε βουνά, Δίπλα σε παιδικό σταθμό, Δίπλα στο μετρό, Δίπλα σε πάρκο, Κέντρο πόλης, Θέα στη θάλασσα, Ήσυχη περιοχή, Πολυτελής περιοχή, Δίπλα σε σούπερ μάρκετ)* _Δίπλα στη θάλασσα_\n" +
        "- Υποδομές *(Φύλαξη, Ιδιωτική είσοδος, Ζώνη για μπάρμπεκιου, Γκολφ, Υπογειο πάρκινγκ, Γήπεδο τένις, Παιδική χαρά, CCTV, Γυμναστήριο, Ανελκυστήρας, Κλειστός κολυμβητικός χώρος, Υποδοχή, Φραγμένος χώρος, Θέρμανση δαπέδου, Βεράντα, Βιώσιμος σχεδιασμός, Ηλιακοί συλλέκτες, Θερμομόνωση, Κελάρι, Ταράτσα, Κήπος, Γκαράζ, Οικόπεδο, Αποθήκη, Σάουνα)* _Κοντά σε γυμναστήριο_\n" +
        "- Ανέσεις ανακαίνισης *(Μεγάλο μπαλκόνι, Σύγχρονος σχεδιασμός, Μεγάλη κουζίνα, Πανοραμικά παράθυρα, Μπάνιο με μπανιέρα, Ηλιακό θερμοσίφωνα, Παρκέ σε όλα τα υπνοδωμάτια)* _Με σύγχρονο σχεδιασμό_\n" +
        "- Πρόσθετες ανέσεις *(Καλύτερη τιμή, Συμφωνηθέντα, Χωρίς ΦΠΑ, Νομιμοποιητικά έγγραφα)* _Δείξε με την καλύτερη τιμή_",
        "Για να λάβετε περισσότερες πληροφορίες σχετικά με ένα συγκεκριμένο ακίνητο, πληκτρολογήστε '*εμφάνιση με* _id ακινήτου_'. Μπορείτε επίσης να χρησιμοποιήσετε την εντολή '*λεπτομέρειες για* _πρώτο|τελευταίο_ *αγγελίας*' αφού εμφανιστεί η λίστα.",
        "Εάν θέλετε να επανεκκινήσετε τη συνομιλία και να διαγράψετε όλες τις προηγούμενες πληροφορίες, απλώς πείτε *Επαναφορά*",
    ],
    hello: [
