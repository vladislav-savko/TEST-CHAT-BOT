export default {
    ...
    property: {
        ...
        buildigConditions: `Κατάσταση κτιρίου`,
        ...
        listingType: {
            sale: `Πώληση`,
            rent: `Ενοικίαση`,
            shortRent: `Βραχυχρόνια ενοικίαση`,
        },
        propertyType: {
            apartment: `Διαμέρισμα`,
            villa: `Βίλα`,
            detachedHouse: `Ανεξάρτητο σπίτι`,
            semiDetachedHouse: `Ημι-ανεξάρτητο σπίτι`,
            office: `Γραφείο`,
            hotel: `Ξενοδοχείο`,
            manufacturing: `Βιομηχανία`,
            retailSpace: `Εμπορικός χώρος`,
            publicCateringFacility: `Δημόσιος χώρος εστίασης`,
            warehouse: `Αποθήκη`,
            carParking: `Χώρος στάθμευσης`,
            shop: `Κατάστημα`,
            restaurant: `Εστιατόριο`,
            otherCommercial: `Άλλο εμπορικό`,
            commercialPlot: `Εμπορικό οικόπεδο`,
            residentialPlot: `Οικόπεδο κατοικίας`,
            agriculturePlot: `Γεωργικό οικόπεδο`,
        },
    },
};
